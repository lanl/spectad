...
*-----------------------------------------------------------------------
      subroutine prmst73(natom,maxtyp,rcut,amu,azero,itype73)
*-----------------------------------------------------------------------
      ...
      stop 'etype=73 not implemented in this version of TAD'     
      
      return
      end
      
c**********************************************************************
      subroutine g73(natom,nmove,x,y,z,itype,tax,tay,taz,ietype,maxtyp
