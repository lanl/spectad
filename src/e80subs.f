...
*-----------------------------------------------------------------------
      subroutine prmst80(natom,maxtyp,rcut,amu,azero,taxes)
*-----------------------------------------------------------------------

      implicit real*8(a-h,o-z)

      dimension rcut(maxtyp,maxtyp),amu(maxtyp),taxes(3)
      dimension azero(maxtyp)

      stop 'etype=80 not implemented in this version of TAD'     
      
      return
      end
      
c**********************************************************************
      subroutine g80(natom,nmove,x,y,z,itype,tax,tay,taz,ietype,maxtyp
