...
*-----------------------------------------------------------------------
      subroutine prmst78(ntype,maxtyp,rcut,amu,azero)
*-----------------------------------------------------------------------
      ...
      stop 'Lennard-Jones not implemented in this version of TAD'     
      
      return
      end
      
c**********************************************************************
      subroutine g78(natom,nmove,x,y,z,itype,tax,tay,taz,ietype,maxtyp
