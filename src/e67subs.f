...
*-----------------------------------------------------------------------
      subroutine prmst67(ntype,maxtyp,rcut,amu,azero)
*-----------------------------------------------------------------------
      ...
      stop 'AIREBO not implemented in this version of TAD'     
      
      return
      end
      
c**********************************************************************
      subroutine g67(natom,nmove,x,y,z,itype,tax,tay,taz,ietype,maxtyp
