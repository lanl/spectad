...
*-----------------------------------------------------------------------
      subroutine prmst27(natom,maxtyp,rcut,amu,azero)
*-----------------------------------------------------------------------
      ...
      stop 'etype=27 not implemented in this version of TAD'     
      
      return
      end
      
c**********************************************************************
      subroutine g27(natom,nmove,x,y,z,itype,tax,tay,taz,ietype,maxtyp
