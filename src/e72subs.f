...
*-----------------------------------------------------------------------
      subroutine prmst72(natom,maxtyp,rcut,amu,azero,taxes)
*-----------------------------------------------------------------------
      ...
      stop 'etype=72 not implemented in this version of TAD'     
      
      return
      end
      
c**********************************************************************
      subroutine g72(natom,nmove,x,y,z,itype,tax,tay,taz,ietype,maxtyp
